...
export default function SignUpPage() {
  return (
    <main className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0a] relative overflow-hidden">
      ...
      {/* Floating orbs */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#8B5CF6]/10 rounded-full blur-[120px] animate-pulse" />
      <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-[#00CED1]/10 rounded-full blur-[100px] animate-pulse [animation-delay:1s]" />
      ...
      <div className="relative z-10">
        ...
        <SignUp
          appearance={{
            ...
            elements: {
              rootBox: 'mx-auto',
              card: 'bg-[#141414]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_60px_rgba(139,92,246,0.15)] rounded-2xl',
